...
export const TRANSLATIONS = {
	en: {
		...
		betaText: "Forge is currently in beta and is available only to a limited number of computers involved in the project. If you have access, you may use it freely, test it, and use it in your own Roblox projects.",
